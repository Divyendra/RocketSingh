...
import org.rocketsingh.android.rocketsinghpillion.ui.navdrawer.DrawerItems.DrawerItem;
import org.rocketsingh.android.rocketsinghpillion.utilities.DisplayUtils;
import org.rocketsingh.android.rocketsinghpillion.utilities.GoogleApiClientHelperActivity;
 ...
 */
public class RSDrawerActivitywithGoogleApi extends GoogleApiClientHelperActivity {
    ...
    private void initMenuDrawer() {
        ...
        //Tieing together the functionality of DrawerLayout and the framework ActionBar to implement the recommended design for navigation drawers.
                ...
                public void onDrawerOpened(View drawerView) {
                    if (!mUserLearnedDrawer) {
                        ...
                        SharedPreferences sp = PreferenceManager
                                .getDefaultSharedPreferences(RSDrawerActivitywithGoogleApi.this);
            ...
            if (!mUserLearnedDrawer) {
                ...
                //After opening automatically, assume that the user has learnt and never auto open again.
                mUserLearnedDrawer = true;
                SharedPreferences sp = PreferenceManager
                        .getDefaultSharedPreferences(RSDrawerActivitywithGoogleApi.this);
                sp.edit().putBoolean(PREF_USER_LEARNED_DRAWER, true).apply();
        ...
        /**Probably the only method used by a Activity which needs a drawer.
         * Creates a menu drawer and attach it to the caller activity.
