...
public final class RequestData extends Message {
  ...
  public RequestData(String entity_id, Integer entity_type, String time_id, String request_status_flag, TripData tripData) {
  ...
  private RequestData(Builder builder) {
    this(builder.entity_id, builder.entity_type, builder.time_id, builder.request_status_flag, builder.tripData);
    setBuilder(builder);
  }
