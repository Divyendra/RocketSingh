...
public class TaskFragment extends Fragment {
    ...
    public void startPostTaskProto_ResponseStatus(Object postArgs[]) {
        //postArgs would have params required to do a http post (like destination URL and JSON to be sent)
        mTask = new HttpPostAsyncTaskProto();
        httpType = POST_STATUS;
        startedTask = true;
        mTask.execute(postArgs);
    }

    public void startPostTaskProto_ResponseProto(Object postArgs[]) {
        //postArgs would have params required to do a http post (like destination URL and JSON to be sent)
        mTask = new HttpPostAsyncTaskProto();
    ...
    public void startGetTaskProto(Object postArgs[]) {
        //postArgs would have params required to do a http post (like destination URL and JSON to be sent)
        mTask = new HttpPostAsyncTaskProto();
        httpType = GET;
        startedTask = true;
    ...
    private class HttpPostAsyncTaskProto extends AsyncTask<Object, Integer, String> {
        ...
        protected String doInBackground(Object... params) {
            ...
            try {
                ...
                try {
                    ...
                    Crashlytics.setString("MESSAGE", "While Sending Proto in TaskFragment");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result == "success") {
                if (mCallbacks != null) {
                    mCallbacks.onPostExecute(responeContent);
                }
            }
        }
