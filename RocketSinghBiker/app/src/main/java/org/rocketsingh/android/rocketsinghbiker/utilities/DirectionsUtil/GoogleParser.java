...
public class GoogleParser  {
    ...
    private URL feedUrl;
    public enum Status {
        FAILED,ZERORESULTS,RETRY,SUCCESS;
    }
    ...
    public ArrayList<Route> parse() throws IOException, JSONException {
        ...
        try {
            ...
            if (json.has("status")) {
                Log.i("STATUS: ", "STATUS:= " + json.getString("status"));
                if (json.has("error_message")) {
                    Log.i("STATUS: ", "error_message:= " + json.getString("error_message"));
                }
                switch (json.getString("status")) {
                    case "OK": status = Status.SUCCESS;break;
                    case "ZERO_RESULTS": status = Status.ZERORESULTS;return routes;
                    case "UNKNOWN_ERROR": status = Status.RETRY; return routes;
                    case "INVALID_REQUEST":
                    case "OVER_QUERY_LIMIT":
                    case "REQUEST_DENIED": status = Status.FAILED; return null;
                }
            }
    ...
    private static String convertStreamToString(final InputStream input) throws IOException {
